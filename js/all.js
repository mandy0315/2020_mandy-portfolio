$(document).ready(function () {
    ...
    function worksTabs() {
        ...
        $tab.on('click', function () {
            ...
            $content.eq($tabIndex).fadeIn(1500).addClass("animate__animated animate__backInUp").css('display', 'block').siblings().css('display', 'none').removeClass("animate__animated animate__backInUp");
        });
    }
    // 偵測跳頁-左右滑動
